...
cp -r envkey-assets/build/fonts envkey-assets/build/images envkey-assets/build/javascripts envkey-assets/build/stylesheets envkey-electron/assets/
cp envkey-assets/build/*.js envkey-electron/assets/

...
const pickMeta = R.pick(["parentType", "parentId", "envUpdateId", "isOnboardAction", "environment"])

export const

  queueEnvironmentImport = createAction(QUEUE_ENVIRONMENT_IMPORT, R.pick(["environment", "parsed"]), pickMeta),
  ...
  importSingleEnvironment = createAction(IMPORT_SINGLE_ENVIRONMENT, R.pick(["environment", "parsed"]), pickMeta)
export const
  ...
  INVITE_EXISTING_USER_INVALID_PASSPHRASE = "envkey/INVITE_EXISTING_USER_INVALID_PASSPHRASE",
  ...
  LOG_TO_SESSION = "envkey/LOG_TO_SESSION",

  COMMIT_SANITIZED_ACTION_LOG = "envkey/COMMIT_SANITIZED_ACTION_LOG",
  COMMIT_SANITIZED_ACTION_LOG_REQUEST = "envkey/COMMIT_SANITIZED_ACTION_LOG_REQUEST",
  COMMIT_SANITIZED_ACTION_LOG_SUCCESS = "envkey/COMMIT_SANITIZED_ACTION_LOG_SUCCESS",
  COMMIT_SANITIZED_ACTION_LOG_FAILED = "envkey/COMMIT_SANITIZED_ACTION_LOG_FAILED",

  REPORT_SANITIZED_ERROR = "envkey/REPORT_SANITIZED_ERROR",
  REPORT_SANITIZED_ERROR_REQUEST = "envkey/REPORT_SANITIZED_ERROR_REQUEST",
  REPORT_SANITIZED_ERROR_SUCCESS = "envkey/REPORT_SANITIZED_ERROR_SUCCESS",
  REPORT_SANITIZED_ERROR_FAILED = "envkey/REPORT_SANITIZED_ERROR_FAILED",

  EXPORT_ORG = "envkey/EXPORT_ORG",
  EXPORT_ORG_SUCCESS = "envkey/EXPORT_ORG_SUCCESS",
  EXPORT_ORG_FAILED = "envkey/EXPORT_ORG_FAILED",

  START_V2_UPGRADE = "envkey/START_V2_UPGRADE",
  START_V2_UPGRADE_REQUEST = "envkey/START_V2_UPGRADE_REQUEST",
  START_V2_UPGRADE_REQUEST_SUCCESS = "envkey/START_V2_UPGRADE_REQUEST_SUCCESS",
  START_V2_UPGRADE_REQUEST_FAILED = "envkey/START_V2_UPGRADE_REQUEST_FAILED",
  START_V2_UPGRADE_SUCCESS = "envkey/START_V2_UPGRADE_SUCCESS",
  START_V2_UPGRADE_FAILED = "envkey/START_V2_UPGRADE_FAILED",

  CANCEL_V2_UPGRADE = "envkey/CANCEL_V2_UPGRADE",
  CANCEL_V2_UPGRADE_SUCCESS = "envkey/CANCEL_V2_UPGRADE_SUCCESS",
  CANCEL_V2_UPGRADE_FAILED = "envkey/CANCEL_V2_UPGRADE_FAILED",

  FINISH_V2_UPGRADE = "envkey/FINISH_V2_UPGRADE",
  FINISH_V2_UPGRADE_SUCCESS = "envkey/FINISH_V2_UPGRADE_SUCCESS",
  FINISH_V2_UPGRADE_FAILED = "envkey/FINISH_V2_UPGRADE_FAILED",

  CHECK_V2_CORE_PROC_ALIVE = "envkey/CHECK_V2_CORE_PROC_ALIVE",
  CHECK_V2_CORE_PROC_ALIVE_SUCCESS = "envkey/CHECK_V2_CORE_PROC_ALIVE_SUCCESS",
  CHECK_V2_CORE_PROC_ALIVE_FAILED = "envkey/CHECK_V2_CORE_PROC_ALIVE_FAILED",

  V2_WAIT_FOR_CORE_PROC_ALIVE = "envkey/V2_WAIT_FOR_CORE_PROC_ALIVE",
  V2_WAIT_FOR_CORE_PROC_ALIVE_SUCCESS = "envkey/V2_WAIT_FOR_CORE_PROC_ALIVE_SUCCESS",

  V2_CORE_PROC_LOAD_UPGRADE = "envkey/V2_CORE_PROC_LOAD_UPGRADE",
  V2_CORE_PROC_LOAD_UPGRADE_SUCCESS = "envkey/V2_CORE_PROC_LOAD_UPGRADE_SUCCESS",
  V2_CORE_PROC_LOAD_UPGRADE_FAILED = "envkey/V2_CORE_PROC_LOAD_UPGRADE_FAILED",

  V2_UPGRADE_GENERATE_ENVKEYS = "envkey/V2_UPGRADE_GENERATE_ENVKEYS",
  V2_UPGRADE_GENERATE_ENVKEYS_SUCCESS = "envkey/V2_UPGRADE_GENERATE_ENVKEYS_SUCCESS",
  V2_UPGRADE_GENERATE_ENVKEYS_FAILED = "envkey/V2_UPGRADE_GENERATE_ENVKEYS_FAILED",

  CHECK_V2_UPGRADE_STATUS = "envkey/CHECK_V2_UPGRADE_STATUS",
  CHECK_V2_UPGRADE_STATUS_SUCCESS = "envkey/CHECK_V2_UPGRADE_STATUS_SUCCESS",
  CHECK_V2_UPGRADE_STATUS_FAILED = "envkey/CHECK_V2_UPGRADE_STATUS_FAILED",

  V2_UPGRADE_ACCEPT_INVITE = "envkey/V2_UPGRADE_ACCEPT_INVITE",
  V2_UPGRADE_ACCEPT_INVITE_SUCCESS = "envkey/V2_UPGRADE_ACCEPT_INVITE_SUCCESS",
  V2_UPGRADE_ACCEPT_INVITE_FAILED = "envkey/V2_UPGRADE_ACCEPT_INVITE_FAILED",

  START_V2_ORG_USER_UPGRADE = "envkey/START_V2_ORG_USER_UPGRADE",
  START_V2_ORG_USER_UPGRADE_SUCCESS = "envkey/START_V2_ORG_USER_UPGRADE_SUCCESS",
  START_V2_ORG_USER_UPGRADE_FAILED = "envkey/START_V2_ORG_USER_UPGRADE_FAILED",

  FINISH_V2_ORG_USER_UPGRADE = "envkey/FINISH_V2_ORG_USER_UPGRADE",
  FINISH_V2_ORG_USER_UPGRADE_SUCCESS = "envkey/FINISH_V2_ORG_USER_UPGRADE_SUCCESS",
  FINISH_V2_ORG_USER_UPGRADE_FAILED = "envkey/FINISH_V2_ORG_USER_UPGRADE_FAILED",

  CLEARED_V2_UPGRADE_OVERLAY = "envkey/CLEARED_V2_UPGRADE_OVERLAY"
